...
const ChangeLog = require(path.join(
  __dirname,
  '..',
  'schemas',
  'changelog_schema'
  ...
  schema.methods.changes = function(changelog) {
    ...
    //continue computing changes
      ...
      const priorityHasChanged =
        this.priority &&
        !this.priority.equals(latestPriorityChangeLog.priority);
      ...
      const assigneeHasChanged =
        this.assignee &&
        !this.assignee.equals(latestAssigneeChangeLog.assignee);
      ...
      const isValid =
        ...
        changelog.assignee ||
        changelog.comment ||
        changelog.resolvedAt ||
        changelog.reopenedAt;
