...
const ContactMethod = require(path.join(__dirname, 'contactmethod.schema'));
const Duration = require(path.join(__dirname, 'duration.schema'));
const Call = require(path.join(__dirname, 'call.schema'));
const Media = require(path.join(__dirname, 'media.schema'));
const ChangeLog = require(path.join(__dirname,'changelog.schema'));
