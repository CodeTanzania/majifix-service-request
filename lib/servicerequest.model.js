...
const { Schema, model, ObjectId } = require('@lykmapipo/mongoose-common');
...
const JURISDICTION_AUTOPOPULATE = _.merge({},
  Jurisdiction.OPTION_AUTOPOPULATE, { path: 'jurisdiction', maxDepth: AUTOPOPULATE_MAX_DEPTH }
);

const SERVICEGROUP_AUTOPOPULATE = _.merge({},
  ServiceGroup.OPTION_AUTOPOPULATE, { path: 'group', maxDepth: AUTOPOPULATE_MAX_DEPTH }
);
